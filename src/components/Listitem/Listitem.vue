...
<template>
  <div class='listitem' @click="router.push('/display/articlecontent')" v-if="initSuccess">
    ...
    <div class='itemcenter' v-else>
        <div class='listtop'>
            <span class='itemtime'>1年前</span>
            <a-divider type="vertical" style="height: 14px; background-color: rgb(235, 235, 235)" />
